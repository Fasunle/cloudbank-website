    ...
    <header className='header' ref={menuRef}>
      <div className='navbar'>
        <Link href='/' onClick={closeMenu}>
          <Image src='/images/cloudbank_logo.webp' alt='CloudBank Logo' width={116} height={40} />
        </Link>

        <button className='navbar__btn' onClick={toggleMenu}>
          {!isMenuVisible ? (
            <Image src={'/images/icons/menu-button.svg'} width={25} height={25} alt='' />
          ) : (
            <Image src={'/images/icons/close-menu.svg'} width={25} height={25} alt='' />
          )}
        </button>
          ...
          <nav className='navbar__nav tablet-8:w-[400px] tablet-8:mr-10 lg:w-[502px] lg:mr-14 xl:mr-36'>
            ...
            >
              <button className='navbar__nav-dropdown-btn'>
                ...
                <Image src={'/images/icons/dropdown.svg'} width={25} height={25} alt='' />
              </button>
            ...
            <Link href='/products' className='navbar__nav-link' onClick={closeMenu}>
              Products
            </Link>

            <Link href='/library' className='navbar__nav-link' onClick={closeMenu}>
              Library
            </Link>
            ...
            >
              <button className='navbar__nav-dropdown-btn'>
                <span
                  className={`navbar__nav-link ${
                    currentPathname === '/faqs' || currentPathname === '/contact' ? 'active' : ''
                  }`}
                >
                  Support
                </span>
              ...
              {isSupportDropdownVisible && (
                <div className='navbar__nav-dropdown-menu'>
                  <Link href='/faqs' className='navbar__nav-link' onClick={closeMenu}>
                    FAQs
                  </Link>
                  <Link href='/contact' className='navbar__nav-link' onClick={closeMenu}>
                    Contact
                  </Link>
                </div>
              )}
