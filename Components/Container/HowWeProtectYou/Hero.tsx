...
export default function Hero(props: HeroPropsType) {
  const {
    /*servicesHeroHeading, servicesHeroText, webAppLinks,*/ companyDetails,
    mastercardImage,
  } = props;
  return (
    ...
    //     {servicesHeroText}
    //   </p>
    //   <a href={webAppLinks.home} rel="noreferrer" target="_blank" className="services__hero-cta">Get Started</a>
    // </section>
    <section>
      <div className='how-we-protect-you_header'>
        <h2>This is us. We are Cloud bank</h2>
      </div>
      <div className='how-we-protect-you_office'></div>
      ...
      <div className='how-we-protect-you_bottom-hero'>
        ...
        <div className='how-we-protect-you_bottom-hero_image-container'>
          <Image height={100} width={100} src={mastercardImage.localFile} alt='atm_image' />
        </div>
      </div>
    </section>
  );
